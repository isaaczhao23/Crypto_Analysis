...
```{r}
# Model Equation
fit1 = lm(log.days.ath.atl ~ days.ath.atl + pct.oatl.ath + reg.ath.atl + log.pct.oatl.ath + log.days.oatl.ath + log.reg.ath.atl,df)
summary(fit1)
...
Enter parameters for predicting models
```{r}
ath = 11420
ath_date = "2018-03-04"
atl = 8000
