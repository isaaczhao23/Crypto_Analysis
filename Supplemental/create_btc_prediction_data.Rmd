...
# Create regression
df$reg.ooath.ooatl = abs(regression(start.date = df$ooath.date,end.date = df$ooatl.date))
df$reg.ooatl.oath = abs(regression(start.date = df$ooatl.date,end.date = df$oath.date))
df$reg.oath.oatl = abs(regression(start.date = df$oath.date,end.date = df$oatl.date))
df$reg.oatl.ath = abs(regression(start.date = df$oatl.date,end.date = df$ath.date))
df$reg.ath.atl = abs(regression(start.date = df$ath.date,end.date = df$atl.date))
df$reg.atl.nath =  abs(regression(start.date = df$atl.date,end.date = df$nath.date))
df$reg.ooath.oath =  regression(start.date = df$ooath.date,end.date = df$oath.date)
df$reg.oath.ath = regression(start.date = df$oath.date,end.date = df$ath.date)
df$reg.ath.nath = regression(start.date = df$ath.date,end.date = df$nath.date)
df$reg.ooatl.oatl = regression(start.date = df$ooatl.date,end.date = df$oatl.date)
df$reg.oatl.atl = regression(start.date = df$oatl.date,end.date = df$atl.date)
df$reg.atl.natl = regression(start.date = df$atl.date,end.date = df$natl.date)
