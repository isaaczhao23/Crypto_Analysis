...
df.predicted.diff = cbind(data.frame(observed = df$days.ath.atl),as.data.frame(exp(predict(d.fit6, df, se.fit=T, type='response',interval = "conf",level=0.95)$fit))) %>% arrange(fit)  %>%
