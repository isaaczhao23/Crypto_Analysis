...
```{r}
comparison_graph(comparison_date="2018-04-28", filter_name = c("Bitcoin","Nano","TRON","Ripple","Verge","Binance Coin","Stellar","Cardano","VeChain"))
```

# Creates comparison graph of top 5 marketcap rank coins
```{r}
comparison_graph(comparison_date="2018-04-05", filter_rank = c(11:18))
```
...
```{r}
predict_correction(ooath.date = "2018-01-06", ooatl.date = "2018-02-05",oath.date = "2018-03-04", oatl.date = "2018-04-06", ath.date = "2018-05-05")
```
